...
export SNPE_VERSION=2.26.2.240911
export SNPE_ROOT=/opt/qcom/aistack/qairt/$SNPE_VERSION/
export ANDROID_NDK_ROOT=/opt/qcom/aistack/android-ndk-r25c-linux/
export PATH=${ANDROID_NDK_ROOT}:${PATH}
export HEXAGON_SDK_ROOT=/local/mnt/workspace/Qualcomm/Hexagon_SDK/4.2.0.3/
export SNPE_TARGET_ARCH=aarch64-android
export SNPE_TARGET_STL=libc++_shared.so
export SNPE_TARGET_DSPARCH=hexagon-v73
alias envsetup="source ${SNPE_ROOT}/bin/envsetup.sh"
...
alias pip=pip3
alias vim=nvim
alias okta="sh ~/aws-okta-login.sh"
alias sentinal="sudo /opt/sentinelone/bin/sentinelctl control start"
...
export LD_LIBRARY_PATH="/home/antonio/.tensornvme/lib:$LD_LIBRARY_PATH"
# <<< tensornvme initialize <<<
